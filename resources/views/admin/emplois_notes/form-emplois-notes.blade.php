...
@section('title', 'Ajouter un grade emploi')
@section('content')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Ajouter un nouveau grade emploi</h1>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <!-- Formulaire -->
                        <form method="POST" action="{{ route('emploi_grade.store') }}">
                            @csrf
